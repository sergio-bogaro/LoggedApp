...
export const buttonVariants = cva( [
  ...
  variants: {
    ...
    size: {
      ...
      sm: "h-8 rounded-control gap-1.5 px-3 has-[>svg]:px-2.5 pointer-coarse:h-11",
      xs: "rounded-control gap-1.5 py-1 px-2 pointer-coarse:min-h-11",
      lg: "h-10 rounded-control px-6 has-[>svg]:px-4 pointer-coarse:h-12",
